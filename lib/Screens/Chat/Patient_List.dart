                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return snapshot.hasError
                              ...
                              : CustomCard(pid: doc['uid'],did:loggedInUser.uid,
                              p_name :doc['name'],last_name :doc['last name'],
                              phone:doc['phone'],profileImage: doc['profileImage'],);  // child widget, replace with your own
                        },
                      ),
                    );
            }
...
class CustomCard extends StatelessWidget {
  ...
  CustomCard({required this.did,
    required this.pid,
    required this.p_name, required this.last_name,required this.phone, this.profileImage});
        ...
        print("ub="+profileImage);
         Navigator.push(
            ...
            MaterialPageRoute(builder: (contex) => ChatScreen(
                pid: pid,p_name: p_name,last_name:last_name, did: did,phone:phone)));
      },
      child: Column(
        children: [
          ListTile(
