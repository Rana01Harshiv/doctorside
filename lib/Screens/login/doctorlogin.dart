...
class Docterlogin extends StatefulWidget {
  const Docterlogin({Key? key}) : super(key: key);

  @override
  State<Docterlogin> createState() => _DocterloginState();
}

late UserCredential userCredential;

class _DocterloginState extends State<Docterlogin> {
  var _isObscure = true;
              ...
              child: Container(
                child: Column(
                  ...
                  children: [
                    ...
                    //       width: size.width * 0.5, height: size.height * 0.20),
                    // ),
                    SizedBox(
